  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-md bg-white rounded-[2.5rem] p-8 shadow-2xl border border-amber-50">
        ...
        {authState.message && (
          <div className="bg-emerald-50 text-emerald-600 p-4 rounded-2xl text-xs font-bold mb-6 border border-emerald-100">
            {authState.message}
          </div>
        )}
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                setAuthStateField('email', e.target.value)
              }
            />
          </div>
          <div className="relative">
            ...
            <input
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                setAuthStateField('password', e.target.value)
              }
            />
          </div>
          <button
        ...
        <div className="mt-8 flex flex-col items-center gap-4">
          <button
            onClick={toggleMode}
            className="text-sm font-black text-amber-600 uppercase tracking-widest"
          >
            {authState.isLogin
