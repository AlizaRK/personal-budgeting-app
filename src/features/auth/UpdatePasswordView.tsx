...
const UpdatePasswordView: React.FC<UpdatePasswordViewProps> = ({ supabase, setView }) => {
  const { password, loading, error, setPassword, updatePassword } = usePasswordUpdate(supabase, () => setView('dashboard'));
