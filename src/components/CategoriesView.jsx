...
const CategoriesView = ({ 
  ...
  // Move the form state INSIDE the component
  ...
  const handleCreate = () => {
    ...
    // Pass the object to the parent function
    addCategory({
      name: newCatName,
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
      ...
      <section className="bg-white rounded-[2.5rem] p-6 shadow-xl border border-amber-50">
        ...
        {/* Call handleCreate instead of addCategory directly */}
        <button onClick={handleCreate} className="w-full py-4 bg-amber-500 text-white rounded-2xl font-black shadow-lg hover:bg-amber-600 transition-all">Create Category</button>
      </section>
